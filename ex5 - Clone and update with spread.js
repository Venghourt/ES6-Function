...
function updateStudentGrade(studentsArray, idToUpdate, newGrade) {
  // Step 1: Find the index of the student with the given ID
  ...
  if (indexToUpdate !== -1) {
    ...
    // Step 4: If the student is not found, log a message and return the original array
